...
public class UpdateController {
    ...
    public ResponseEntity<HttpStatus> lastName(@RequestParam String email, @RequestParam String password, @RequestParam String newLastName) {
        loginController.validateLoginInformation(email, password);
    ...
    public ResponseEntity<HttpStatus> targetDailyWorkingTime(@RequestParam String email, @RequestParam String password, @RequestParam double targetDailyWorkingTime) {
        loginController.validateLoginInformation(email, password);
        var human = humanRepository.getById(email);
    ...
    public ResponseEntity<HttpStatus> defaultProjectId(@RequestParam String email, @RequestParam String password, @RequestParam int projectId) {
        loginController.validateLoginInformation(email, password);
        var human = humanRepository.getById(email);
